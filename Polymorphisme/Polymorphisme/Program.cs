...
namespace Polymorphisme
{
    ...
    class contry
    {
        public void contryLangage()
        {
            Console.WriteLine("Il a pour langue maternele : ");
        }
        public virtual void residancePersonne(String valeur) { }
    }
    ...
    class Comorien : contry
    {
        ...
        private int cmpt = 0;
        public override void residancePersonne(String valeur)
        {
